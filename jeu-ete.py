...
root.title('tt')
frameprincipale = Frame(root,width=1200,height=600,bg=couleurprin)###on cree une frame 1000*600 (taille de la fenetre)
...
framescore.pack(side=LEFT,padx=20)
scoreframe=Frame(framescore)
scoreframe.grid()
ecritureinfo= ("Helvetica", 16)
ecritureequipe= ("Helvetica", 25)
ecriture=("Helvetica", 30)
ecriturechrono= ("Helvetica", 100)
scoreequipe1=StringVar()
scoreequipe1.set("0")
scoreequipe2=StringVar()
scoreequipe2.set("0")
labelscore=Label(scoreframe,text="SCORE",font=ecritureequipe)
labelscore.grid(row=0, column=1)
labelequipe1=Label(scoreframe,text="Equipe 1",font=ecritureequipe)
labelequipe1.grid(row=1, column=0)
labelequipe2=Label(scoreframe,text="Equipe 2",font=ecritureequipe)
...
labelscoreequipe1=Label(scoreframe,textvariable=scoreequipe1,font=ecritureequipe)
labelscoreequipe1.grid(row=2, column=0)
labelscoreequipe2=Label(scoreframe,textvariable=scoreequipe2,font=ecritureequipe)
labelscoreequipe2.grid(row=2, column=2)

#################################jeu nom
framejeu=Frame(frameprincipale)
framejeu.pack(side=LEFT,padx=75)
jeuframe=Frame(framejeu)
jeuframe.grid()
avancementjeu=StringVar()
avancementjeu.set("0 / 40")
labelavancementjeu=Label(jeuframe,textvariable=avancementjeu,font=ecritureequipe)
labelavancementjeu.grid(row=0, column=0)
equipejoue=StringVar()
equipejoue.set("Equipe 1")
labelequipejoue=Label(jeuframe,textvariable=equipejoue,font=ecritureequipe)
labelequipejoue.grid(row=1, column=0)
nomatrouver=StringVar()
labelnomatrouver=Label(jeuframe,textvariable=nomatrouver,font=ecriture)
...
frameprin.pack(side=LEFT,padx=10)
frameavancement=Frame(frameprin)
frameavancement.grid(row=0, column=0)
labelmanchepre=Label(frameavancement,text="manche : ",font=ecritureinfo)
labelmanchepre.grid(row=0, column=0)
labelmanche=Label(frameavancement,textvariable=manche,font=ecritureinfo)
labelmanche.grid(row=0, column=1)
...
labelchrono.grid(row=0, column=0,padx=20)
